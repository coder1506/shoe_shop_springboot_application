...
public class MySQLConf {
	@Bean(destroyMethod = "close") protected DataSource dataSource() {
        ...
        dataSourceConfig.setJdbcUrl("jdbc:mysql://127.0.0.1:3306/shop?useUnicode=yes&characterEncoding=UTF-8");
	...
	@Bean protected LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactoryBean.setPackagesToScan("com.shoes_shop"); // root
