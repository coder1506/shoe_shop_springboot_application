                ...
                <div class="right">
                    <div class="right__content">
                        ...
                        <div class="right__formWrapper">
                            <form:form action="${pageContext.request.contextPath}/admin/product/addproduct" modelAttribute="product" method="post" enctype="multipart/form-data">
                                ...
                                <div class="right__inputWrapper">
                                    <label for="image">Ảnh giới thiệu</label>
                                ...
                                <div class="right__inputWrapper">
                                    ...
                                    <form:textarea name="" id="" cols="30" rows="5" placeholder="Mô tả được hiển thị ở sản phẩm"  path="shortDes"/>
                                </div>
                                <div class="right__inputWrapper">
                                    <label for="desc">Chất liệu và kĩ thuật</label>
                                    <form:textarea name="" id="" cols="30" rows="5" placeholder="Chất liệu và kĩ thuật"  path="metarial_vs_skill"/>
                                </div>
                                <div class="right__inputWrapper">
										<label>Details description</label>
										<form:textarea id="editor" placeholder="Mô tả được hiển thị ở chi tiết sản phẩm" class="form-control"  path="shortDetails"/>
									</div>
