                    ...
                    <div class="left__content">
                        ...
                        <ul class="left__menu">
                            <li class="left__menuItem">
                                <a href="${pageContext.request.contextPath}/admin/dashboard" class="left__title"><img src="/assets/icon-dashboard.svg" alt="">Dashboard</a>
                            </li>
                            <li class="left__menuItem">
                                ...
                                <div class="left__text">
                                    <a class="left__link" href="${pageContext.request.contextPath}/admin/addproduct">Thêm Sản Phẩm</a>
                                    <a class="left__link" href="${pageContext.request.contextPath}/admin/viewproduct">Xem Sản Phẩm</a>
                                </div>
                            </li>
                            <li class="left__menuItem">
